...
4. Download the latest release of Bartender from releases.
...
2. Once you see this notification, go to releases and get the latest release `.jar`.
...
## Report bugs
- You can report bugs/crashes/problems in issues. Please describe the problem in detail and include the steps to reproduce.
