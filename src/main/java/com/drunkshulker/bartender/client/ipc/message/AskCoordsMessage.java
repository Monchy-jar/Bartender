...
import static com.drunkshulker.bartender.client.ipc.IPCHandler.ASK_COORDS;


public class AskCoordsMessage implements MappedBusMessage {
    Charset charset = StandardCharsets.UTF_8;

    public static final int TYPE = ASK_COORDS;

    private int x,y,z;
    byte[] senderName;

    public AskCoordsMessage() {}

    public AskCoordsMessage(int x, int y, int z, String senderName) {
        this.x=x;
        this.y=y;
        this.z=z;
    ...
    public String toString() {
        return "AskCoordsMessage ["+charset.decode(ByteBuffer.wrap(senderName)).toString()+"] ["+x+","+y+","+z+"]";
    }
