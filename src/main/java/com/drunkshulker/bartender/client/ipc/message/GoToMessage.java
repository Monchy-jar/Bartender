...
public class GoToMessage implements MappedBusMessage {
    Charset charset = StandardCharsets.UTF_8;

    public static final int TYPE = IPCHandler.GO_TO;
    ...
    public GoToMessage(int x, int y, int z, String senderName) {
        this.x=x;
        this.y=y;
        this.z=z;
    ...
    public String toString() {
        return "GoToMessage ["+charset.decode(ByteBuffer.wrap(senderName)).toString()+"] ["+x+","+y+","+z+"]";
    }
